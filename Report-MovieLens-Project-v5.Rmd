...
According to the results on validation set, RMSE of "Regularized Movie + User + Genres  Effects Model" is 0.8644514 which is lower than target RSME (0.86490). **The validation data set was used to evaluate the RMSE of the final algorithm only.** 
